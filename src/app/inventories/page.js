...
export default function InventoryPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === "add") {
        ...
        await inventoryAPI.updateInventoryItem(selectedItem.sku, itemData)
      }
  ...
  // Get unique brands and categories from inventory
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="p-3 rounded-lg" style={{ backgroundColor: "#FFE3EC" }}>
                <Warehouse size={24} style={{ color: "#E213A7" }} />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-800">
                  {formatPrice(inventory.reduce((total, item) => total + item.current_stock * item.cost_price, 0))}
                </p>
              </div>
              <div className="p-3 rounded-lg" style={{ backgroundColor: "#FFE3EC" }}>
                    ...
                    {inventory.map((item, index) => {
                      ...
                      return (
                        <tr key={item.sku || index} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="w-10 h-10 rounded-lg bg-pink-100 flex items-center justify-center mr-3">
                                <Warehouse size={20} style={{ color: "#E213A7" }} />
                              </div>
                              <div>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-gray-600">{item.brand || "No Brand"}</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-gray-600">{item.category || "No Category"}</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
              ...
              {inventory.length === 0 && !loading && (
                <div className="text-center py-12">
                  <div className="text-gray-400 mb-4">
                    <Warehouse size={48} className="mx-auto" />
                  </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 rounded-lg bg-pink-100 flex items-center justify-center">
                    <Warehouse size={32} style={{ color: "#E213A7" }} />
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-gray-800">{itemToView.name}</h4>
                    <p className="text-sm text-gray-600">{itemToView.description}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-800">{itemToView.brand || "No Brand"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Category:</span>
                      <span className="font-medium text-gray-800">{itemToView.category || "No Category"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Location:</span>
                      <span className="font-medium text-gray-800">{itemToView.location || "Unknown"}</span>
                    </div>
                  </div>
                </div>
                ...
                {/* Physical Attributes */}
                {(itemToView.color || itemToView.shade || itemToView.size) && (
                  <div>
