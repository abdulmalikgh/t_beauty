...
export default function ProductsPage() {
  ...
  // Form data - updated to include image fields
  ...
  return (
     <DashboardLayout title="Products" subtitle="Manage Products" currentPath="/products">
                          ...
                          <div className="flex items-center">
                            <div className="w-10 h-10 rounded-lg bg-pink-100 flex items-center justify-center mr-3">
                              {product.thumbnail_url || product.primary_image_url ? (
                                <img
                                  src={product.thumbnail_url || product.primary_image_url}
                                  alt={product.name}
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                {/* Additional Images */}
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Additional Image URLs</label>
                  {formData.image_urls.map((url, index) => (
                    <div key={index} className="flex items-center space-x-2 mb-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-300 focus:border-transparent"
                        placeholder="https://example.com/image.jpg"
                      />
                      {index === 0 && (
                        <button
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-6">
                Are you sure you want to delete <span className="font-medium">"{productToDelete.name}"</span>? This will
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center space-x-4">
                <div className="w-16 h-16 rounded-lg bg-pink-100 flex items-center justify-center">
                  {productToView.thumbnail_url || productToView.primary_image_url ? (
                    <img
                      src={productToView.thumbnail_url || productToView.primary_image_url}
              ...
              {/* Images */}
              {productToView.image_urls && productToView.image_urls.length > 0 && (
                <div>
                  <h5 className="text-md font-medium text-gray-800 mb-3">Images</h5>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {productToView.image_urls.map((url, index) => (
